...
- Requires [PHP SoapClient](https://www.php.net/manual/en/class.soapclient.php) installed in the hosting environment. The availability of the extension can be checked with the help of WordPress - [PHP info](https://wordpress.org/plugins/php-info-wp/) plugin, as the resulted riporting page (soap > Soap Client	enabled ; Soap Server	enabled).
